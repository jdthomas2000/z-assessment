    ...
    return (
      <>
        <div className="flex items-center mt-4">
          <h1 className="text-2xl font-bold">
            No user inventory for current user: {userObj[0].username}
          </h1>
  ...
  return (
    <>
      <div className="flex items-center gap-4 mt-4">
        ...
        <button className="btn btn-neutral" onClick={() => openAddModal()}>
          Add Item
        </button>
        {addModal && (
          <AddItemModal
      ...
      <span className="text-sm text-grey-600 font-medium mt-3">
